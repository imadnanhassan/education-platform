                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {teachersData.map((teacher, index) => (
                        <div key={teacher.id} className={cn(
                            ...
                            {/* Card */}
                            <div className="bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all duration-300 h-full border border-gray-100">
                                {/* Teacher Image */}
                                <div className="relative">
                                    ...
                                    {/* Rating Badge */}
                                    <div className="absolute top-4 right-4 flex items-center bg-white/90 backdrop-blur-sm rounded-full px-3 py-1 shadow-sm">
                                ...
                                <div className="p-6">
                                    ...
                                    <div className="mb-4">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {teacher.subjects.map((subject, idx) => (
                                                <span key={idx} className="bg-green-100 text-green-700 text-xs font-medium px-3 py-1 rounded-full border border-green-200">
                                                    {subject}
                                                </span>
                                            ))}
                                        </div>
                                    ...
                                    {/* Contact Button */}
                                    <button className="w-full bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white py-3 px-6 rounded-xl font-semibold transition-all duration-300 shadow-md">
                                        যোগাযোগ করুন
                                    </button>
                                </div>
                            </div>
