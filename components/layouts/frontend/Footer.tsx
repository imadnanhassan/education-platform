                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center space-x-2">
                            ...
                            />
                            <div>
                                <h3 className="text-xl font-bold text-primary-400">গ্র্যাভিটন একাডেমি</h3>
                                <p className="text-sm text-gray-400">Education & Abroad Preparation</p>
                            </div>
                        </div>
                    ...
                    {/* Quick Links */}
                    <div>
                        <h4 className="text-lg font-semibold mb-4 text-primary-400">দ্রুত লিংক</h4>
                    ...
                    {/* Abroad Preparation */}
                    <div>
                        <h4 className="text-lg font-semibold mb-4 text-primary-400">বিদেশে পড়াশোনা</h4>
                        <ul className="space-y-2">
                    ...
                    {/* Company */}
                    <div>
                        <h4 className="text-lg font-semibold mb-4 text-primary-400">প্রতিষ্ঠান</h4>
                        <ul className="space-y-2">
