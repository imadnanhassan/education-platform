                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <label htmlFor="privacy" className="ml-2 text-sm text-gray-600">
                                        আমি <a href="/privacy" className="text-primary-600 hover:text-primary-700">গোপনীয়তা নীতি</a> এবং <a href="/terms" className="text-primary-600 hover:text-primary-700">শর্তাবলী</a> সম্মত।
                                    </label>
                                </div>
            ...
            <div className="bg-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-gray-900 mb-4">আমাদের অবস্থান</h2>
                        <p className="text-lg text-gray-600">আমাদের অফিসে সরাসরি আসতে চাইলে নিচের ম্যাপ দেখুন</p>
                    </div>
                    ...
                    <div className="bg-gray-200 rounded-lg h-96 flex items-center justify-center">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600">Google Maps এখানে embed করা হবে</p>
                        </div>
                    </div>
                </div>
            </div>
